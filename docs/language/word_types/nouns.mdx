---
sidebar_position: 1
description: "A comprehensive guide to Hîsyêô nouns, detailing their roles through prepositions, genitive relationships, and how to create noun phrases from verbs and modifiers."
---
...
[connector](./connectors), it indicates a new sentence fragment.
...
During causative sentences, a noun phrase with this role represents the
*causer*. During non-causative sentences, a noun phrase with this role will be
the **agent** or **experiencer** of the action or state. In linguistics this
case is known as the **agentive** case. Additionally, during non-causative
sentences, the marked noun phrase is considered to be making the choice to
commit the act or experience the state of the predicate of their own free will. 
...
During causative sentences, a noun phrase with this role will represent the
*causee*. During non-causative sentences, a noun phrase with this role can be
used to represent the agent or experiencer of the action. Unlike the previous
particle, the marked noun phrase is **not** making the choice to commit the act
of their own free will. Either they are bound/forced to do so or they do not
have the wherewithal to make a conscious choice on the matter and are acting out
of some basic instinst. In linguistics, this case is sometimes referred to as
the **causal-agentive** case.
...
Unlike the other preposition particles, you can provide a verb without also
providing a direct object noun phrase. Simply start another preposition, use a
connector to create a compound sentence, use a comma to end a clause or use a
period to end a sentence (the only thing you can't do is immediately follow a
verb directly with another verb because it will always be perceived as being the
direct object of the preceding verb). Not using this noun phrase slot can have
an impact on how base verb sentences are interpreted. Without providing a direct
object, a base verb is interpreted as being *intransitive* or in an unthematic
and generic manner (since no theme is being provided). That being said,
sometimes it's easiest to just think of an implicit <HisyeoWord is='ni'/>
...
suffix (adverbs) or some senses of the words "by" and "with". In linguistics,
this might be seen as a kind of adverbial case but the word "adverbial" is
ill-fitting to the grammar of Hîsyêô so the term **methodological** case is
being used instead.

:::info Thematic Relations

This preposition and the remaining described here can be used with sentences
that contain intransitive and transitive verbs and are only needed in certain
circumstances when extra thematic information is useful to describing the
predicate in a new way. These prepositions are known as **true thematic
relations**. The prepositions above, the subjects (<HisyeoWord is='û'/> or
<HisyeoWord is='ôlê'/>) and direct objects are honorary members of the thematic
relation club since they are traditionally referred to as **morphosyntactic
...
The <HisyeoWord is='li'/> particle precedes this noun phrase.

This role is used when the noun is describing the subject (a noun complement), roughly equivalent to "is a [noun]" in English.

Because <HisyeoWord is='li'/> is a preposition, if it is used without an explicit subject, it creates an existential statement ("There is [noun]").

<HisyeoTabs>
  <p>noyo li ônî bêûdo.&emsp;<em>I am a student.</em></p>
  <p>li môtô.&emsp;<em>There is fire.</em></p>
  <p>li gô hoî niwos.&emsp;<em>(It) is at home.</em></p>
</HisyeoTabs>
...
<HisyeoTabs>
  ...
  <p>nîo fuî sî tômôs xe hoî zomo mulô sûn sokofû mût deku.&emsp;<em>He had books piled from floor to ceiling.</em></p>
  ...
  <p>kôî wedo til doînbî sûn lono dus xêtî yê wuto xêtî.&emsp;<em>Tickets are available from 17th July.</em></p>
...
The <HisyeoWord is='til'/> particle precedes this noun phrase.
...
under <HisyeoWord is='til'/> so we've included an in-depth walkthrough of most
...
<HisyeoTabs>
  <p>noyo fuî uyo til nîmû&emsp;<em>I have something for you.</em></p>
</HisyeoTabs>
3. ✅ In order to help, benefit, gratify, honor etc. (someone or something). 
<HisyeoTabs>
  <p>hôn môî uyo fos noyo tûu, û noyo tûu til nîmû.&emsp;<em>Everything I do, I do for you.</em></p>
  <p>nûs fuî kôndodû yê lono kon lôzîc til umo Zêenit.&emsp;<em>We're having a birthday party for Janet.</em></p>
  <p>ônî bôklôn cûdo sî kôto in ondo til kôndodû kon cûdo yôûlî.&emsp;<em>The mayor gave a speech for the charity gala.</em></p>
</HisyeoTabs>
4. ✅ Befitting of someone’s beliefs, needs, wants, skills, or tastes; best suited to.
<HisyeoTabs>
  <p>hôn fos xe wêko mokon hoî zuko bi dûndon, li eswen en fos nîmû kôî tûu, bînê wêloi ôfo til yôk nîmû.&emsp;<em>If having to bag the groceries correctly is more than you can handle, then this isn't the job for you.</em></p>
</HisyeoTabs>
5. ✅ To be used or treated in a stated way, or with a stated purpose.
<HisyeoTabs>
  <p>ôfo li gongoxî ûlôgun nêôs til oûtô gîsgûl noyo.&emsp;<em>This is a new bell for my bicycle.</em></p>
  <p>bîek sûît onô til kôndodû yê ûsên dizêl yê umo Tomu ûn Helen.&emsp;<em>The cake is for Tom and Helen's anniversary.</em></p>
  <p>kûôxi ôfo hoî ôfo til xe mokon. dîzel til xe li êo fonmot.&emsp;<em>These apples here are for eating. The rest are for throwing away.</em></p>
</HisyeoTabs>
6. ✅ Supporting, in favour of. (Antonym: against)
<HisyeoTabs>
  <p>noî môî umo xe til bêsnêhot, kûu li êo nô bi mulô ôlê zûngô nîmû.&emsp;<em>All those for the motion, raise your hands.</em></p>
  <p>zik til mozûn bukû.&emsp;<em>Who's for ice-cream?</em></p>
  <p>noyo til xe li nô tô oûtô kîskô.&emsp;<em>I'm for going by train.</em></p>
  <p>dus gôcîdon sî til ûn niswî dên.&emsp;<em>Ten voted for, and three against. (with implied object)</em></p>
</HisyeoTabs>
7. ⛔ Because of. 
<HisyeoTabs>
...
<HisyeoTabs>
  <p>cîgîlsu in mokon til hûstun nîmû.&emsp;<em>This medicine is for your cough.</em></p>
  <p>noyo buswen xe isbulyol nozî hoî niwos til mûxî mîtmo nomû.&emsp;<em>I need to spray my house for termites.</em></p>
</HisyeoTabs>
...
12. ✅ On behalf of.
<HisyeoTabs>
  <p>noyo wedo cizî til nîo.&emsp;<em>I will stand in for him.</em></p>
  <p>noyo kôto til ônî bôklôn wîk.<em>I speak for the Prime Minister.</em></p>
</HisyeoTabs>
...
<HisyeoTabs>
  ...
  <p>nîo fuî ûnfûnô zîzîyo misli fos wedo dûuncît nîo til ni.&emsp;<em>He's got a turnip for a brain.</em></p>
</HisyeoTabs>
...
<HisyeoTabs>
  <p>noyo belêxu til mûlû xe hoî kônyêc kûngîyo yê lono cinôbu.&emsp;<em>I am aiming for completion by the end of business Thursday.</em></p>
  <p>nîo bêûdo til cêo yê mulô êto.&emsp;<em>He's going for his doctorate.</em></p>
  <p>nîmû fôlun xe li nô til îskô ûlzo ko.&emsp;<em>xe you want to go for coffee?</em></p>
  <p>umo xe niwos hoî môî boxô yê kûôcyo Elofo, dîyondê sî umo Delfi til zuwobû.&emsp;<em>People all over Greece looked to Delphi for answers.</em></p>
  <p>nîmû kôî li nô mût gubuyo til yoûtî hûwu ko.&emsp;<em>Can you go to the store for some eggs?</em></p>
  <p>noyo wêko munî bi sôbo til oûtô.&emsp;<em>I'm saving up for a car.</em></p>
  <p>kûu motsi yôk til zuwobû.&emsp;<em>Don't wait for an answer.</em></p>
  <p>nîo sôlû mût nîmû til zik.&emsp;<em>What did he ask you for?</em></p>
</HisyeoTabs>
...
<HisyeoTabs>
  <p>til nixîn yê tîmîok pipôk.&emsp;<em>O for the wings of a dove.</em></p>
  <p>til nixîn fos li nô tô nu.&emsp;<em>Ah! for wings to soar …</em></p>
  <p>hôn îbûdû til côûfon yê cêo kut ze.&emsp;<em>And now for a slap-up meal!</em></p>
</HisyeoTabs>
20. ⛔ (in expressions such as 'for a start') Introducing the first item(s) in a potential sequence .
<HisyeoTabs>
  <p>tûu kon dodê tô woyû in besol nu. hôn kut uyo û noyo kôî dodê yôk lôîcôk.&emsp;<em>Go scuba diving? For one thing, I can't even swim.</em></p>
  <p>hôn dîzel û nûs fuî yôk ozûul yôn.&emsp;<em>For another, we don't have any equipment.</em></p>
</HisyeoTabs>
21. ✅ (with names, chiefly US) In honor of; after.
<HisyeoTabs>
  <p>somo mût nîo til motûo motûo nîo.&emsp;<em>He is named for his grandfather.</em></p>
</HisyeoTabs>
...
<HisyeoTabs>
  <p>nîo gomî sî wokût kon wêloi xe gitno lono ûn bitûn, til fos nîo kôî dôstoc eswen wokût odigon.&emsp;<em>He took the swing shift for he could get more overtime.</em></p>
</HisyeoTabs>

:::

When <HisyeoWord is='til'/> is used with the negatitive particle <HisyeoWord is='yôk'/>,
...
<HisyeoTabs>
  <p>noyo fuî sôlû hôn zuwobû ilik.&emsp;<em>"I have a question regarding your earlier answers."</em></p>
</HisyeoTabs>
...
complement in a <HisyeoWord is='hôn'/> preposition.
...
<HisyeoTabs>
  ...
  <p>nûs kûu oûtô gitno tohilôk pûmi onô til xe bucono wokût cî.&emsp;<em>"We should drive through the mountains to save time."</em></p>
...
The <HisyeoWord is='ilik'/> particle precedes this noun phrase.

This role is used for a noun phrase that represents something that the action or
state of the predicate is *preceded* by, whether in time or space. In English,
this represents some of the senses of the words "before", "prior to", or "in".
In linguistics, this is referred to as the **antessive** case.

<HisyeoTabs>
    <p>noyo fôlun fos ôfo li mûlû ilik lono dûsul.&emsp;<em>I want this done before Monday.</em></p>
    <p>nîo li sî totsi ilik noyo&emsp;<em>He stood before me.</em></p>
    <p>nûs sityo ilik môtô onô til fos li êo tût yoûtî ôlê cizi nûs.&emsp;<em>We sat before the fire to warm ourselves.</em></p>
    <p>zîwit mûlû nîmû ilik nîmû.&emsp;<em>Your whole life is before you.</em></p>
</HisyeoTabs>
...
The <HisyeoWord is='cihôû'/> particle precedes this noun phrase.

This role is used for a noun phrase that represents something that the action or
state of the predicate is *followed* by, whether in time or space. In English,
this represents some of the senses of the words "after", "post", or "on". In
linguistics, this might be considered a kind of temporal or terminative case or
perhaps most likely the **postessive** case.

<HisyeoTabs>
    <p>noyo fiyûxît nîmû til xe bôklôn bi dîzel cihôû foût fêlcîn nîmû.&emsp;<em>I'm not putting you in charge again after your last mistake.</em></p>
    <p>cihôû fos nîo uskîfo sûn îlê kûlûnun û nîo kôs fos eswen dûî umo li sî tônkô.&emsp;<em>After he escaped from prison, he had two additional victims.</em></p>
    <p>nûs cînlî yoûtî îskô cihôû kelo onô.&emsp;<em>We had a few beers after the game.</em></p>
    <p>noyo mût nîo kôto sî xe li êo bundu ôlê zinkon onô cihôû nîo.&emsp;<em>I told her to shut the door after her.</em></p>
</HisyeoTabs>
...
This role is used for a noun phrase that represents something that the action or
state of the predicate resembles or is a likeness of. It can also be used to
introduce a [simile](https://en.wikipedia.org/wiki/Simile). In English, this
represents some of the senses of the words "like" and "as". When used with a
subordinate clause, it can also represent the English phrase "as if". In
linguistics, this might be thought of as a kind of essive case. However, there
is some concern that this case term accurately reflects the functionality in
Hîsyêô. So, the term **similative** case is used instead.
...
<HisyeoTabs>
  ...
  <p>golfon onô fos noyo oncêmon ni cihôû xe dêko non foko ôsôlê yê kônyêc wêxôn fêlcîn misli yôk ozûul uyo fos noyo oncêmon sî hoî ôhêl.&emsp;<em>The disgust I felt after watching last weekend's horror movie was unlike anything I had felt before.</em></p>
  <p>umo Kiloûdîo bi xûnyu cokyen îskô uyo cûbû misli yôk umo Filit fos poxô kon îskô cûbû bi cokyen li niwos dûî yê.&emsp;<em>Claudia hardly ever drinks beer or wine, unlike Phillip, for whom the bar is practically a second home.</em></p>
...
You can clarify that a genitive relationship is possessive by using <HisyeoWord is='fuî'/>: 

<HisyeoTabs>
    <p>cîkînîl yê fuî yê zonwul&emsp;<small>(lit. ear of possession of animal)</small></p>
</HisyeoTabs>
...
alone or <HisyeoWord is='fuî'/> and <HisyeoWord is='dî'/>:

<HisyeoTabs>
    <p>îlê yê fuî yê dî kôdus&emsp;<em>(lit. building of possession of sacred trait)</em></p>
</HisyeoTabs>
...
You can clarify a genitive relationship is content by using <HisyeoWord is='fuî'/> <HisyeoWord is='lîmîen'/>:

<HisyeoTabs>
  <p>zomo xîmu yê fuî lîmîen yê mîcîn&emsp;<small>(lit. water body of inner possession of fish)</small></p>
</HisyeoTabs>
...
inner <HisyeoWord is='til'/> preposition:

<HisyeoTabs>
  <p>tômôs xe (li gô) til umo xonluk&emsp;<small>(lit. books that are (existing) for young people)</small></p>
</HisyeoTabs>
...
You can clarify that a genitive relationship is production by using <HisyeoWord is='til'/>:
...
<HisyeoTabs>
    <p>kon lîûbît yê ôcôto&emsp;<em>"love of God"</em> <small>(lit. loving of God)</small></p>
</HisyeoTabs>
...
<HisyeoTabs>
    <p>noyo ûn ôcôto lîûbît xokôn dîzel.&emsp;<small>(lit. I and God love each other)</small></p>
</HisyeoTabs>
...
A modifier cannot act directly as a noun. It must be preceded by the abstract
non particle <HisyeoWord is='kon'/>. When doing so, it means an uncountable
quality and/or degree of being a given state. Like the affix "-ness" in English.
Despite this, you can still use a modifier as the nucleus of a verb or a
preposition phrase and when doing so, it's usually for a verb or preposition
where an adjective is thematically meaningful. Sometimes, an adjective that
exists as the nucleus of a noun phrase may be considered to be an impersonal
pronoun with the word as dependent modifier. Be careful not to misuse the direct
object slot for adverbial modifiers.

<HisyeoTabs>
  <p>wôlik nêlô kôs kon kûyô&emsp;<em>"Black clouds cause sadness."</em></p>
  <p>noyo li xowosê.&emsp;<em>"I am happy"</em></p>
  <p>nîo wêîlun xôn.&emsp;<em>"He behaved well"</em></p>
  <p>nîo dêko hûnsik&emsp;<em>"They saw red"</em></p>
  <p>nîo li nô bi fîkî&emsp;<em>"She moves fast"</em></p>
</HisyeoTabs>

Just like with verbs you can create a genitive phrase by preceding the modifier
with the <HisyeoWord is='yê'/> particle. This is useful for the typical reason
that genitive phrases are useful: it allows you to describe a quality with some
modifiers of its own. One of the most common usages is when adding a degree to a
modifier:
...
to formulate otherwise. In fact, modifiers can also be used with <HisyeoWord is='ônî'/> to
make explicit impersonal pronouns (if using a bare modifier would be ambiguous) and
with  <HisyeoWord is='foko'/> to make causative agents of that modifier.
...
<HisyeoTabs>
  ...
  <p><strong>xe</strong> golo, li xôn til umo xonluk.&emsp;<em>"Reading is good for kids."</em></p>
</HisyeoTabs>
...
<HisyeoTabs>
    <p>bi fos bi ubênus wuîtsî xe ogolol, noyo lunsol sî gundolê nubuso yê zomo onô bi gîôn sumon en fos noyo kôî tûu.&emsp;<em>"Barely keeping a grip on it, I throw the dog's wet ball as hard as I can."</em></p>
