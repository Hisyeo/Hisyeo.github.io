...
or word changes that you might normally make. Each Hisyëö content word can be
...
think of the Hisyëö word as covering **all** of these words. This is why we
...
Hisyëö is also an art language because it has taken the core of Kokanu and added
many aesthetic, syntactic, and semantic ideas that allow it to be used as an
everyday communication platform right now albeit with a starting "culture" in a
similar way to how art language creators establish history to explain their
language's idiosyncracies. The cultural lexicon of Hisyëö is a representation of
what the creators believe to be
...
find in a natural society (and in artlangs). Because of this, there's a risk
that these ideas will fade as the language gains a true living culture. The
community must remain vigilant that the things that make Hisyëö great never fade
...
Until there are volumes of Hisyëö writings to consume, we will have to make due
with oral communication. The first step on the road to oral communication is to
learn the common phrases that are the lifeblood of any encounter with a Hisyëö
...
<HisyeoTabs>
    ...
    <p>nü küu lı lö ci.&emsp;<em>Let's go!</em></p>
    <p>(nimü) (lı gö) bı zık.&emsp;<em>How are you doing?</em></p>
    <p>(noyo) (lı gö) bı xön.&emsp;<em>I am well.</em></p>
    <p>lono nimü lı si gö bı zık.&emsp;<em>How has your day been?</em></p>
    <p>(nı) (lı gö) bı yök xön.&emsp;<em>Not good.</em></p>
    <p>zık lı yonlüs.&emsp;<em>What's wrong?</em></p>
    <p>(nı) lı yök sonkon&emsp;<em>It doesn't matter.</em></p>
    <p>küu yünlön (noyo).&emsp;<em>Sorry!</em></p>
    <p>küu lı yök cinzon.&emsp;<em>Don't worry!</em></p>
    <p>(noyo) lı konxo (hön nimü).&emsp;<em>Thank you!</em></p>
    <p>(nı) lı yök ixölö.&emsp;<em>It's not a problem.</em></p>
    <p>(nı) lı xünyu (uyo).&emsp;<em>It's nothing. (You're welcome.)</em></p>
...
with certain speakers but *all of the words of Hisyëö were chosen in such a way
...
##### ö - [open-mid back rounded vowel](https://en.wikipedia.org/wiki/Open-mid_back_rounded_vowel) [ɔ]
...
##### ë - [close-mid front unrounded vowel](https://en.wikipedia.org/wiki/Close-mid_front_unrounded_vowel) [e]
- as in m**a**y or f**a**ce
- can also be rounded [ø]
- *slightly geminated*

##### ı - [near-close near-front unrounded vowel](https://en.wikipedia.org/wiki/Near-close_near-front_unrounded_vowel) [ɪ]
...
##### ü - [close back rounded vowel](https://en.wikipedia.org/wiki/Close_back_rounded_vowel) [u]
...
Check out the [phonology reference](../reference/phonology) for more details.
