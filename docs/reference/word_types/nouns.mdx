...
When you use a noun clause as the nucleus of a thematic relation phrase, it has
some special meanings:

- Manner/Material: Accusative Relative Clause (Describes the direct object)
- Instrument/Means: Nominal Subordinate Clause
- Location/Time: Iterative Condition Subordinate Clause ("whenever")
- Direction/Destination: Terminative Condition Subordinate Clause ("until")
- Source/Origin: Inchoative Condition Subordinate Clause ("since")
- Beneficiary/Purpose: Nominal Subordinate Clause
- Cause: Nominal Subordinate Clause
- Collaborator: Corrective Subordinate Clause (Describes a change in the action)
- Context/Condition: Perfective Condition Subordinate Clause ("if")
- Counter-Agent: Nominal Subordinate Clause
- Evidence: Nominal Subordinate Clause
- Distance/Duration: Durative Condition Subordinate Clause ("while", "during")
- Intermediate: Nominal Subordinate Clause
- Similative: Comparative Condition Subordinate Clause ("as if")
