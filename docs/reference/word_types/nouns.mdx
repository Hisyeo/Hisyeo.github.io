...
this represents some of the senses of the word "to" and "into". Although, many
English verbs don't rely on a preposition to introduce their direct object.
...
remember is that only base verbs can take a preposition of this kind. A sentence
with a base modifier or base noun being used as a verb cannot contain this
preposition.
