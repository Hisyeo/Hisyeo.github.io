...
first noun phrase of a sentence, the particle can be elided (omitted).
...
**recipient**, you can use this preposition to describe that constituent.
...
This role is used for noun phrases that either represent a special kind of goal/agent for
...
- an entity that the action or state *was* in the midst of but is now on the other
  side, or
- a conjunction of two noun phrases that represent two boundaries in time or space that the
