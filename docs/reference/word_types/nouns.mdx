...
Here <HisyeoWord is='mokon'/> is being used as direct obect noun of the action
...
A verb can act as a noun when connected to a noun phrase using the <HisyeoWord is='yë'/> particle.

<HisyeoTabs>
    <p>müt noyo küu oköt dıbo öfo yë conwëbo.&emsp;<em>"Bring me that box of goods."</em></p>
    <p>küu wëko yogö onö hoi dıbo yë kelo et onö.&emsp;<em>"Put the pieces in the game box."</em></p>
</HisyeoTabs>
...
<HisyeoTabs>
    <p>timiok kon wëtodü yë towë wik pipök&emsp;<em>"bald eagle"</em> <small>(lit. hunting bird of white head feathers)</small></p>
    <p>öntön züngö kon kelo yë kon doicël gundolë&emsp;<em>"baseball glove"</em> <small>(lit. playing hand glove of ball catching)</small></p>
</HisyeoTabs>
...
agent of some action or state. For the first particle (<HisyeoWord is='öni'/>),
...
<HisyeoTabs>
    <p>foko mefüs wowoë yë kon lö fiki&emsp;<em>"running shoes"</em><small>(lit. foot safe-causer of fast moving)</small></p>
    <p>öni lö fiki&emsp;<em>"runner"</em><small>(lit. fast mover)</small></p>
    <p>fecko foko hünsık&emsp;<em>"red paint"</em><small>(lit. red-causer liquid)</small></p>
    <p>öni wëko yë fecko foko longı&emsp;<em>"painter"</em><small>(lit. placer of color-causer liquid)</small></p>
</HisyeoTabs>
...
<HisyeoTabs>
  <p>töxütsı bümi yë ıwotë ëto&emsp;<em>"very tall mountain"</em></p>
</HisyeoTabs>

Since Hisyëö has less than 900 words, using genitive phrases with modifiers
allows you to create more complex phrases that would require several sentences
to formulate otherwise. In fact, modifiers can also be used with <HisyeoWord is='kon'/>, <HisyeoWord is='öni'/>,
and <HisyeoWord is='foko'/> to make modifier-based abstract and agentive nouns.

<HisyeoTabs>
    <p>foko liülë yë ënkömön longı et küyö&emsp;<em>"a sad clown"</em></p>
    <p>kolowo kon xobo foko dës tönkö&emsp;<em>"non-violent martial arts"</em></p>
</HisyeoTabs>
...
<HisyeoTabs>
  ...
  <p><strong>xe</strong> golo, lı xön oxon umo xonluk.&emsp;<em>"Reading is good for kids."</em></p>
</HisyeoTabs>
...
subjectless ("there is" or "it is") depending on the predicate that is provided.
This form of noun phrase is useful when you need to introduce a clause that
changes (or removes) the subject from the underlying sentence. Some verbs
...
When you use a subordinate clause as the nucleus of a thematic relation phrase,
...
<HisyeoTabs>
    <p>bı fos bı ubënus wuitsi xe ogolol, noyo lunsol si gundolë nubuso yë zomo onö bı len sumon en fos noyo köi tüu.&emsp;<em>"Barely keeping a grip on it, I throw the dog's wet ball as hard as I can."</em></p>
    <p>bı fos unon iskö cübü ün biek sün, nü dënëmëk xe yosten gufuyo kon iskö onö hoi sınsi cüti onö.&emsp;<em>"Smelling of beer and bread, we searched the small town for the local tavern."</em></p>
    <p>bı xe sıtyo hoi mötö onö, lı zowo xe tö hoköli ogolol si sıskın wohi nimü.&emsp;<em>"Sitting by the fire was the dog that bit your sister."</em></p>
</HisyeoTabs>

:::caution Why the shift in meaning

It might seem like this should just describe the manner since that's what this
thematic relation is for. But, it isn't used for that in this case because the
...
instead of using a thematic relation marker. This frees up this marker (when
supplied with a subordinate clause) to be used for describing the direct object.
Semantically, this is the only valid place that can take a relative clause.
Given that this marker is the only one that applies the supplied noun phrase
*adverbially*, it follows that any subordinate clause should be interpreted as
being related to the nucleus of the direct object.
...
this thematic relation with a subordinate clause is still meant to be
...
thematic roles, the usage of this thematic relation with a subordinate clause is
...
of this thematic relation with a subordinate clause is still meant to be
...
#### Context/Condition: Perfective Condition Subordinate Clause

When the context/condition thematic role is applied to a *noun clause*, they do
reflect normal subordinate clauses but since this thematic relation fits the
special class of context/condition, there's a special way to intepret its usage
wth noun clauses. The meaning is taken as a **perfective condition** which in
English can be interepreted as a clause prefaced by "if".
...
usage of this thematic relation with a subordinate clause is still meant to be
