...
The %%zö|zö%% particle precedes the this noun phrase.

This particle is used for transitive verbs that have an additional argument. The
argument represents a patient (an entity receiving some action) or a theme (a
specific descriptive element that greatly alters the interpretation of the
verbal action but isn't itself affected by the action).
