...
Hîsyêô is new kind of project, where instead of just creating a *language*, a
full-fledged *culture* was created alongside it. To build an auxiliary path for
connection between people across the world, there needs to be a *complete*
language system that unites them and that requires details of a society,
beliefs, practices and worldview. Without this, different learning groups will
fill in the blanks based upon their native language and culture.

The new culture is one that emphasizes egalitarian, humanitarian, and
environmentalist values. Check out the models of [participatory
economics](https://participatoryeconomy.org) and
[parpolity](https://znetwork.org/znetarticle/parpolity-political-vision-for-a-good-society-by-stephen1-shalom)
for a good background of the organization structure that this community seeks to
follow. 

## What is the Hîsyêô language?

A small language of less than 900 words; 96% of the words are nouns, verbs and
adjectives that never mutate when used. There's just a few dozen special grammar
words that introduce different parts of the sentence. The Hîsyêô language was
...
syntax separate particle words. Alternatively, many languages mutate (synthetic)
or attach (agglutinative) lexemes to root words in order to achieve similar
grammatical means.
...
improves expressiveness at the cost of *some* amount of neutrality. However,
since the grammar provides more functionality and conventions than some
minimalist languages, Hîsyêô is able to reduce ambiguity which the creators of
the language believe to be a second-order form of neutrality.
...
learn are contrary to the practices of typical [International Auxiliary
Languages](http://interlanguages.net). Hîsyêô **does not** strictly follow the
tradional principles (and isn't seeking to fit in any kind of IAL-shaped box).
The creators of the language believe that too much effort within IAL development
is spent on regularization and cherrypicking existing lexical and grammatical
tactics of natural languages (while applying some first language bias regardless
of the best intentions) without putting significant effort into semantics (i.e.,
a *sound* system of meaning) and pragmatics (the cultural scripts for
interaction and dialogue). Instead, Hîsyêô pushes closer to a
...
striving for a more complete "batteries-included" approach to grammar. Or,
closer to a [artlang](https://en.wikipedia.org/wiki/Artistic_language) by
including a full culture and social system.
...
([koanu](https://web.archive.org/web/20231127095333/https://www.parallax.net.nz/x/koanu/))
and decided to try to create his own kokanido, enhancing it with some ideas
taken from other constructed and natural languages.

After reading books on cross-linguistic semantics, pragmatics and the limits of
interpretation, the creator decided that more cultural details were needed to
flesh out a truly ideal language. In addition to creating a strong starting
point for a new worldview, it also reduces the impact of imperialist and
capitalist cultures that are prevalent in internet communities today.
...
the [phonology reference](language/phonology).
