...
grammar provides more functionality than some minimalist languages and certain
conventions are established to ensure the language can be a more functional
replacement of a natural language. This does add complexity and bloat but it
also reduces ambiguity, increases expressivity, and presents an easier
language acquisition path for most learners.
...
and grammar choices. With just over 840 words, there's a lot more ways to
...
The creators believe that too much effort within IAL development is spent on
...
acceptance, respect, love, solidarity and creativity. Through the language
...
5. If the agent/experiencer phase is placed as the first constituent of a
...
<HisyeoTabs>
   ...
   <p>pioli&emsp;<em>hello</em></p>
   <p>sütüö&emsp;<em>friend</em></p>
</HisyeoTabs>

#### Choose a sentence ender:
<HisyeoTabs>
   <p>lötven&emsp;<em>polite</em></p>
   <p>voxo&emsp;<em>surprise</em></p>
...
<HisyeoTabs>
   ...
   <p>nimü vısun sütüö noyo ko&emsp;<em>Do you know my friend?</em></p>
</HisyeoTabs>
