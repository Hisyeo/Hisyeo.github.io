...
#### Choose a subject (preceded by <HisyeoWord is='ü'/>):
<HisyeoTabs>
   <p>noyo <em>I</em></p>
   <p>nimü <em>you</em></p>
   <p>nü   <em>we</em></p>
...
#### Choose a verb (preceded by <HisyeoWord is='lı'/> or omitted if first):
<HisyeoTabs>
...
#### Choose an object (preceded by <HisyeoWord is='cö'/>):
<HisyeoTabs>
   <p>ulyö   <em>that</em></p>
...
<HisyeoTabs>
   <p>ü noyo lı mokon cö küöxı <em>I eat fruit</em></p>
   <p>vısun ü nimü cö sütüö ko <em>Do you know a friend?</em></p>
</HisyeoTabs>
