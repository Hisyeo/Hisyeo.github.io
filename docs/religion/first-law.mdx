...
Law, there are times, however rare, when the slightest disobedient movement of
...
into networks of strain (however ephemeral). The First Law's power was supposed
to be absolute and these networks should have dissipated. However, we are aware
of ten of them that were somehow able to assemble themselves into maintained
